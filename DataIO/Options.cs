...
namespace LevelDB
{
    ...
    public class Options : LevelDBHandle
    {
        ...
        {
            set { LevelDBInterop.leveldb_options_set_create_if_missing(Handle, value ? true : false); }
        }
        ...
        {
            set { LevelDBInterop.leveldb_options_set_error_if_exists(Handle, value ? true : false); }
        }
        ...
        {
            set { LevelDBInterop.leveldb_options_set_paranoid_checks(Handle, value ? true : false); }
        }
